...
exports.parse = function (argv) {
  ...
  program
    ...
    .action(function handleInstallMrpis () {
      ...
      //   https://github.com/twolfson/youtube-music-electron/issues/25#issuecomment-167368775
      if (process.versions.electron) {
        throw new Error('`install-mpris` command should be handled by `bin/youtube-music-electron.js`');
      }
